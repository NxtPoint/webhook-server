...
**In flight:** p14 probe (`86ade942` / Batch `8c6b973d`, rev 77). Validate: `.claude/tmp/p11_validate.py 86ade942-7472-4c55-b17c-f18cb0a18a74`. Bars: far 7/12, near ≥13/14, pid-1 off-court ~1%, player rows ~21k.
