...
- **Return points won %** — the headline figure. What share of your opponent's service points did you win? Anything above 37% means you are returning better than the average player; consistently above 40% and you are a genuine threat on return.
- **First-serve vs second-serve return win %** — split your return performance by the serve you faced. Most players are far too passive on second-serve returns, treating a 75 mph second serve with the same caution as a 110 mph first. The second-serve return is your best break opportunity in the match, and the data usually shows you are leaving points on the table there.
- **Return depth** — did your return land deep, in the middle third, or short? Depth neutralises the server. A deep return pushes them back and takes away their easy first-strike forehand; a short return invites them to step in and dictate. Depth is the single most coachable return habit, and it shows up clearly on a court map.
- **Return direction and placement** — where are your returns going? Cross-court, down the line, or floating through the middle? The middle of the court is where returns go to die: it gives the server the easiest next ball and the widest angles. Knowing your placement spread tells you whether you have a plan or you are just making contact.
- **Break points created and converted** — the bottom line of return performance. How many break points did your return game generate, and how many did you take? A player who creates plenty but converts few has a pressure problem, not a return problem — and that is a completely different thing to train.
...
These are not insights you can pull from memory after a tense three-setter. They only appear when every return is logged, located, and counted — which is precisely what computer-vision [match analysis](https://www.ten-fifty5.com/overview) does automatically.
...
- **Set a depth target.** If your data shows short, central returns under pressure, make depth your single focus for a block of practice. Aim returns past the service line into the back third. One clear target beats five vague ones.
- **Attack the second serve.** If your second-serve return win rate lags your first, give yourself permission to step inside the baseline and take the ball early. Track the number over the next few matches and watch it move.
- **Pick a side and commit.** Floating returns through the middle is the most common leak in club tennis. Decide — cross-court depth as your default, down-the-line as your change-up — and let your placement data tell you whether you are executing.
- **Review break points specifically.** Filter your matches for the break points you created and study what your return did on those points. Patterns under pressure are where the real gains hide.

For juniors and the parents and coaches tracking their development, the return profile is one of the clearest long-term progress markers there is. A defender becoming a counter-puncher, a passive returner learning to attack the second serve — these shifts show up in the trend lines months before they show up in the win-loss record. That is exactly the kind of development a [coaching workflow](https://www.ten-fifty5.com/coaching) is built to surface and act on.

Your serve gets all the attention because it feels like the shot you control. But the return is where the breaks live, and breaks are where matches are decided. Start measuring the half of your game you have been guessing about, and you will find points you did not know you were leaving on the court. See how it works on your own footage on the [how-it-works](https://www.ten-fifty5.com/overview) page, or [check the plans](https://www.ten-fifty5.com/pricing) when you are ready to dig into your data.
